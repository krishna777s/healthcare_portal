  ...
  return (
    <div className="p-6 space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-muted-foreground">Manage hospital departments and specializations</p>
      </div>
        ...
        {departments.map((dept, index) => (
          ...
          >
            <CardContent className="p-6">
              ...
              <p className="text-sm text-muted-foreground mb-4">{dept.specialty}</p>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-semibold text-foreground">{dept.staff}</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center gap-2">
